...
{
$sql=mysqli_query($con,"SELECT Password FROM  hospital where Password='".sha1(md5($_POST['password']))."' && H_id='".$_SESSION['id']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update hospital set Password='".sha1(md5($_POST['npass']))."', updationDate='$currentTime' where H_id='".$_SESSION['id']."'");
