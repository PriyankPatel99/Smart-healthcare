...
if(isset($_GET['del']))
		  {
		          mysqli_query($con,"delete from nurse where N_id = '".$_GET['id']."'");
...
$sql=mysqli_query($con,"insert into nurse(H_id,F_Name,L_Name,Address,City,Pincode,Email,Contect,Password) values('$h_id','$f_name','$l_name','$address','$city','$pincode','$email','$contect','$passsha1')");
if($sql)
{
...
<html>
	...
	<link rel="stylesheet" type="text/css" href="http://localhost/smart_healthcare/fontawesome/iconic/css/material-design-iconic-font.min.css">
       ...
       <script src="http://localhost/smart_healthcare/css/cssall/js/demo.js" type="text/javascript"></script>
        ...
        <title>Nurse List | Smart Healthcare</title>
...
$sql=mysqli_query($con,"select * from nurse where H_id='".$_SESSION['id']."'");
$cnt=1;
...
?>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a href="nurse_list.php?id=<?php echo $row['N_id']?>&del=delete" onclick="return confirm('Are you sure you want delete this record?')"
...
$cnt=$cnt+1;
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                   ...
                   <form name="registration" id="registration" method="post"  onSubmit="return valid();" action="nurse_list.php"   accept-charset="utf-8" class="form-horizontal login100-form validate-form">
                       <div class="padded">
					...
					<div class="wrap-input2 validate-input" data-validate = "minimum 3 Disit Alphabetic  Last Name">
					 ...
					 <div class="wrap-input100 validate-input" data-validate = "Enter valid Email">
						...
						<div class="wrap-login100-form-btn">
                            ...
                            <button type="submit" name="submit" id="submit" class="login100-form-btn" tabindex=10>Add Nurse </button>
