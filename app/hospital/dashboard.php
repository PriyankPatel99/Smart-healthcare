...
<link rel="stylesheet" type="text/css" href="http://localhost/smart_healthcare/fontawesome/css/all.css">
	...
	<link rel="shortcut icon" href="http://localhost/smart_healthcare/images/logo1.png" type="image/ico" />
        ...
        <title>Hospital dashboard | Smart Healthcare</title>
...
<?php include('include/said.php');?>
  ...
  <div id="hexGridHeader">
    <div class="hexCrop">
         ...
         <div class="hex"></a><span><a href="#" ><i class="fas fa-cogs"  style="font-size:70%"></i></a></span></div>
        <div class="hex"><span><a href="#" ></a></span></div>
        <div class="hex"><span><a href="#" ></a></span></div>
        <div class="hex"><span><a href="#" ></a></span></div>
        <div class="hex"><span><a href="nurse_list.php"><i class="fas fa-user-nurse" style="font-size:70%"></i></a></span></div>
        <div class="hex"><span><a href="#" ></a></span></div>
        <div class="hex"><span><a href="#" ></a></span></div>
        <div></div>
        <div class="hex"><span><a href="#" ><i class="fas fa-ambulance" style="font-size:70%"></i></a></span></div>
        <div class="hex"><span><a href="#" ></a></span></div>
        <div></div>
        <div></div>
        <div></div>
       <div></div>
        ...
        <div class="hex"><span><a href="#" ></a></span></div>
        <div></div>
        <div class="hex"><span><a href="doctor_list.php" ><i class="fas fa-user-md" style="font-size:70%"></i></a></span></div>
        <div class="hex"><span><a href="#" ></a></span></div>
        <div class="hex"><span><a href="#" ></a></span></div>
        <div class="hex"><span><a href="reseptionist.php" ><i class="fas fa-user-tie" style="font-size:70%"></i></a></span></div>
        <div></div>
        <div></div>
        <div></div>
        <div></div>
        <div class="hex"><span><a href="#" ></a></span></div>
        <div></div>
        <div class="hex"><span><a href="#" ><i class="fas fa-wheelchair" style="font-size:70%"></i></a></span></div>
        <div></div>
        <div class="hex"><span><a href="#" ></a></span></div>
        <div></div>
        <div class="hex"><span><a href="#" ></a></span></div>
