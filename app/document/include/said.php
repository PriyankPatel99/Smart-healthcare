	...
	<ul class="nav nav-collapse collapse nav-collapse-primary">
		...
		<li class="">
			...
			<span class="glow"></span>
				...
				<a href="http://localhost/smart_healthcare/app/nurse/dashboard.php" >
 ...
 <!------prescription----->
		...
		<li class="">
			...
			<span class="glow"></span>
				...
				<a href="http://localhost/smart_healthcare/app/nurse/nprescription.php" >
		...
		<li class="">
			...
			<span class="glow"></span>
				...
				<a href="http://localhost/smart_healthcare/app/nurse/profile.php" >
