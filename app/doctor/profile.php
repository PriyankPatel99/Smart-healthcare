...
if(isset($_POST['submit']))
{
   ...
   $demail=$_POST['email'];
   $contact=$_POST['phone'];
   $sql=mysqli_query($con,"Update doctor set F_Name='$fname',L_Name='$lname',Address='$address',City='$city',Pincode='$pincode',Email='$demail',Contect='$contact',updationDate='$currentTime' where D_id='".$_SESSION['id']."'");
   if($sql)
   {
...
else
{
        ...
        if( in_array($imageFileType,$extensions_arr) ){
            ...
            else
			{
                 ...
                 $query = "Update doctor set Profile='$pro',updationDate='$currentTime' where D_id='".$_SESSION['id']."'";
...
<div id="div1" style="color:red; font-size:15px; "><?php echo htmlentities($_SESSION['msgpro']); ?></div>
	 ...
	 <div class="box-content">
		...
		<?php $sql=mysqli_query($con,"select * from doctor where D_id='".$_SESSION['id']."'");
...
<img src='<?php echo $image_src;  ?>' onerror=this.src="http://localhost/smart_healthcare/images/def.jpg">
					 ...
					 <div class="wrap-input2 validate-input" data-validate = "Enter valid Phone No">
