...
{
$sql=mysqli_query($con,"SELECT Password FROM  patient where Password='".sha1(md5($_POST['password']))."' && P_id='".$_SESSION['id']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update patient set Password='".sha1(md5($_POST['npass']))."', updationDate='$currentTime' where P_id='".$_SESSION['id']."'");
