...
<div id="div1" style="color:red; font-size:15px"><?php echo htmlentities($_SESSION['msgnu']); ?></div>
        </div>
     ...
     <div class="container-fluid padded">
                ...
                <div class="box-header">
                    ...
                    <span class="title">
                       ...
                       <i class="fas fa-user-nurse"></i>    Nurse list
                    </span>
