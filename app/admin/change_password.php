...
{
$sql=mysqli_query($con,"SELECT Password FROM  admin where Password='".md5($_POST['password'])."' && A_id='".$_SESSION['id']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update admin set Password='".md5($_POST['npass'])."', updationDate='$currentTime' where A_id='".$_SESSION['id']."'");
