...
<html>
	...
	<link rel="stylesheet" type="text/css" href="http://localhost/smart_healthcare/fontawesome/iconic/css/material-design-iconic-font.min.css">
       ...
       <script src="http://localhost/smart_healthcare/css/cssall/js/demo.js" type="text/javascript"></script>
        ...
        <title>Patient List | Smart Healthcare</title>
...
<div id="div1" style="color:red; font-size:15px"><?php echo htmlentities($_SESSION['msgpa']); ?></div>
        </div>
...
?>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a href="patient_list.php?id=<?php echo $row['P_id']?>&del=delete" onclick="return confirm('Are you sure you want delete this record?')"
