...
if(isset($_GET['del']))
		  {
		          mysqli_query($con,"delete from patient where P_id = '".$_GET['id']."'");
                  $_SESSION['msgd']="Record deleted !!";
		  }
...
<html>
	...
	<link rel="stylesheet" type="text/css" href="http://localhost/smart_healthcare/fontawesome/iconic/css/material-design-iconic-font.min.css">
       ...
       <script src="http://localhost/smart_healthcare/css/cssall/js/demo.js" type="text/javascript"></script>
        ...
        <title>Dead List | Smart Healthcare</title>
...
<div id="div1" style="color:red; font-size:15px"><?php echo htmlentities($_SESSION['msgd']); ?></div>	
            ...
            <!----TABLE LISTING STARTS--->
                ...
                <div class="box-header">
                    ...
                    <span class="title">
                       ...
                       <i class="fas fa-user-slash"></i>  Dead list
                    </span>
...
$sql=mysqli_query($con,"select F_Name,Address,City,Email,p.P_id from patient p, prescription a where p.P_id=a.P_id and opration='Dead'");
$cnt=1;
...
?>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a href="dead.php?id=<?php echo $row['P_id']?>&del=delete" onclick="return confirm('Are you sure you want delete this record?')"
