...
if(isset($_POST['submit']))
{
   ...
   $email=$_POST['email'];
   $contact=$_POST['phone'];
   $sql=mysqli_query($con,"Update admin set Name='$fname',Copy='$address',Email='$email',Contect='$contact',updationDate='$currentTime' where A_id='".$_SESSION['id']."'");
   if($sql)
   {
...
<html>
	...
	<link rel="stylesheet" type="text/css" href="http://localhost/smart_healthcare/fontawesome/iconic/css/material-design-iconic-font.min.css">
       ...
       <script src="http://localhost/smart_healthcare/css/cssall/js/demo.js" type="text/javascript"></script>
        ...
        <title>Admin Profile | Smart Healthcare</title>
...
else
{
 ...
 $micro=round(microtime(true) * 1000);
		...
		$result =mysqli_query($con,"SELECT Profile FROM admin WHERE Profile='$pro'");
...
else
{
        ...
        if( in_array($imageFileType,$extensions_arr) ){
            ...
            else
			{
                 ...
                 $query = "Update admin set Profile='$pro',updationDate='$currentTime' where A_id='".$_SESSION['id']."'";
                  ...
                  move_uploaded_file($_FILES['file']['tmp_name'],'upload/'.$pro);
				   ...
				   header('location:profile.php');
				   $_SESSION['msgpro']="Profile Picture update Successful";
            }
        }
		else
		{
...
<?php include('include/said.php');?>
	...
	<div id="div1" style="color:red; font-size:15px; "><?php echo htmlentities($_SESSION['msgpro']); ?></div>
	 ...
	 <div class="box-content">
		...
		<?php $sql=mysqli_query($con,"select * from admin where A_id='".$_SESSION['id']."'");
...
$sql = "select Profile from admin where A_id='".$_SESSION['id']."'";
...
<img src='<?php echo $image_src;  ?>' onerror=this.src="http://localhost/smart_healthcare/images/def.jpg">
					 ...
					 <div class="wrap-input1 validate-input" data-validate = "minimum 3 Disit Alphabetic  Name">
						<input style="color:#000000" class="input100" type="text" name="Name" placeholder="Name" id="name" tabindex=3 value="<?php echo htmlentities($data['Name']);?>"/>
                        <span class="focus-input100"></span>
						</div>
					
					     <div class="wrap-input100 validate-input" data-validate = "5 character Long Copyright text">
                         <input style="color:#000000" class="input100" type="text"  placeholder="Copyright" name="address"tabindex=4  value="<?php echo htmlentities($data['Copy']);?>"/>
                         <span class="focus-input100"></span>
                    </div>
                      ...
                      <div class="wrap-input3 validate-input" data-validate = "Enter valid Email">
						...
						<input style="color:#000000" class="input100" type="text" placeholder="Pincode" name="phone"  tabindex=5  value="<?php echo htmlentities($data['Contect']);?>" />
						<span class="focus-input100"></span>
					</div>
			
					 <div class="wrap-input100 validate-input" data-validate = "------------">
						<input style="color:#000000" class="input100" type="text" placeholder="Last Update Date&Time" name="-----"  value="Update At <?php echo htmlentities($data['updationDate']);?>" />
						<span class="focus-input100"></span>
					</div>
                      ...
                      <?php } ?>
						...
						<div style="margin-left:9%" class="wrap-login100-form-btn">
                            ...
                            <button type="submit" name="submit" id="submit" class="login100-form-btn" tabindex=6>Update Pro.. </button>
...
?></center>
 ...
 <div class="wrap-input9">
						<div class="wrap-login100-form-btn">
                            ...
                            <input type="file" name="file" class="login100-form-btn" tabindex=1 tabindex=1/>
							<span class="focus-input100"></span>
						...
						<div class="wrap-login100-form-btn">
                            ...
                            <button type="submit" name="but_upload" id="submit" class="login100-form-btn" tabindex=2>Update Pic.. </button>
