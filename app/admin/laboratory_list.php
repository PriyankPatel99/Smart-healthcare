...
if(isset($_GET['del']))
		  {
		          mysqli_query($con,"delete from laboratory where L_id = '".$_GET['id']."'");
                  $_SESSION['msglab']="data deleted !!";
		  }
...
$sql=mysqli_query($con,"insert into laboratory(Gr_no,F_Name,L_Name,Name,Address,City,Pincode,Email,Contect,Password) values('$grno','$f_name','$l_name','$name','$address','$city','$pincode','$email','$contect','$passsha1')");
if($sql)
{
	header('location:laboratory_list.php');
	$_SESSION['msglab']="Laboratory insert Successful";
...
<html>
	...
	<link rel="stylesheet" type="text/css" href="http://localhost/smart_healthcare/fontawesome/iconic/css/material-design-iconic-font.min.css">
       ...
       <script src="http://localhost/smart_healthcare/css/cssall/js/demo.js" type="text/javascript"></script>
        ...
        <title>Laboratory List | Smart Healthcare</title>
                ...
                <div class="area-top clearfix">
                    ...
                    <div class="pull-left header">
                        ...
                        <i class="icon-info-sign"></i>
                         ...
                         Manage Laboratory </h3>
<div id="div1" style="color:red; font-size:12px"><?php echo htmlentities($_SESSION['msglab']); ?></div>
                    </div>
...
$sql=mysqli_query($con,"select * from laboratory");
$cnt=1;
...
?>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a href="laboratory_list.php?id=<?php echo $row['L_id']?>&del=delete" onclick="return confirm('Are you sure you want delete this record?')"
...
$cnt=$cnt+1;
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                   ...
                   <form name="registration" id="registration" method="post"  onSubmit="return valid();" action="laboratory_list.php"   accept-charset="utf-8" class="form-horizontal login100-form validate-form">
                       <div class="padded">
                        ...
                        <div class="wrap-input100 validate-input" data-validate = "minimum 3 Disit Alphabetic Laboratory Name">
						<input class="input100" type="text" name="name" id="name" tabindex=2 />
						<span class="focus-input100" data-placeholder="Laboratory Name"></span>
					</div>
					 ...
					 <div class="wrap-input10 validate-input" data-validate = "Enter 4-16 Disit long Password">
					  ...
					  <div class="wrap-input10 validate-input" data-validate = "Enter 4-16 Disit long Password">
                       ...
                       <div class="wrap-input1 validate-input" data-validate = "minimum 3 Disit Alphabetic City Name">
						<input class="input100" type="text" name="city" id="name" tabindex=6 />
						...
						<div class="wrap-login100-form-btn">
                            ...
                            <button type="submit" name="submit" id="submit" class="login100-form-btn" tabindex=12>Add Lab.. </button>
...
$("#loaderIcon").show();
jQuery.ajax({
url: "laboratory_availability.php",
