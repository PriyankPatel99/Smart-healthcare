...
{
$sql=mysqli_query($con,"SELECT Password FROM  nurse where Password='".sha1(md5($_POST['password']))."' && N_id='".$_SESSION['id']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update nurse set Password='".sha1(md5($_POST['npass']))."', updationDate='$currentTime' where N_id='".$_SESSION['id']."'");
