...
<link rel="stylesheet" type="text/css" href="http://localhost/smart_healthcare/fontawesome/css/all.css">
	...
	<link rel="shortcut icon" href="http://localhost/smart_healthcare/images/logo1.png" type="image/ico" />
        ...
        <title>Reseptionist dashboard | Smart Healthcare</title>
...
<?php include('include/said.php');?>
  ...
  <div id="hexGridHeader">
    <div class="hexCrop">
        ...
        <div class="hex"><span><a href="#" ></a></span></div>
        <div class="hex"><span><a href="#" ></a></span></div>
        <div class="hex"><span><a href="#" ><i class="fas fa-calendar-alt"  style="font-size:70%"></i></a></span></div>
        <div class="hex"><span><a href="#" ></a></span></div>
        <div class="hex"><span><a href="#" ></a></span></div>
        <div class="hex"><span><a href="#" ></a></span></div>
        <div></div>
       ...
       <div></div>
        ...
        <div class="hex"><span><a href="#" ></a></span></div>
        <div></div>
        <div class="hex"><span><a href="work.php" ><i class="fas fa-money-bill-alt" style="font-size:70%"></i></a></span></div>
        <div class="hex"><span><a href="#" ></a></span></div>
        <div class="hex"><span><a href="#" ></a></span></div>
        <div class="hex"><span><a href="laboratory_list.php" ><i class="fas fa-flask" style="font-size:70%"></i></a></span></div>
        <div></div>
        <div></div>
        <div></div>
        <div></div>
