...
{
$ret=mysqli_query($con,"SELECT * FROM reseptionist WHERE Email='".$_POST['email']."' and Password='".sha1(md5($_POST['password']))."'");
$num=mysqli_fetch_array($ret);
if($num>0)
{
$extra="dashboard.php";//
$_SESSION['id']=$num['R_id'];
...
<html lang="en">
<head>
	<title>Reseptionist | Login</title>
	<meta charset="UTF-8">
